...
def plot_stats(history, should_show=True):
    ...
    pyplot.legend()
    pyplot.savefig('loss_ffnn5a.png')
...
def main(args):
    ...
    save_preds = False
    if save_preds:
        numpy.save(file='preds_train_nn5a.npy', arr=preds_train_nn)
        numpy.save(file='preds_test_nn5a.npy', arr=preds_test_nn)
