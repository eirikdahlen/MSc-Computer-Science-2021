...
def main(args):
    ...
    save_preds = True
    if save_preds:
        numpy.save(file='preds_train_nn4.npy', arr=preds_train_nn)
        numpy.save(file='preds_test_nn4.npy', arr=preds_test_nn)
