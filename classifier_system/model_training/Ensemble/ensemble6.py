...
def plot_stats(history, should_show=True):
    ...
    pyplot.legend()
    pyplot.savefig('loss_ffnn_6.png')
...
def main(args):
    ...
    save_preds = True
    if save_preds:
        numpy.save(file='preds_train_nn_6.npy', arr=preds_train_nn)
        numpy.save(file='preds_test_nn_6.npy', arr=preds_test_nn)
