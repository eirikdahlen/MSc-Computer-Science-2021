...
def plot_stats(history, should_show=True):
    ...
    pyplot.legend()
    pyplot.savefig('loss_ffnn6a.png')
...
def main(args):
    ...
    train_predictions = [bert_train_predictions, bertweet_train_predictions,
                         ernie_train_predictions, distilbert_train_predictions, distilbert_balanced_train_predictions,
                         roberta_train_predictions]
    test_predictions = [bert_test_predictions, bertweet_test_predictions, ernie_test_predictions,
    ...
    save_preds = False
    if save_preds:
        numpy.save(file='preds_train_nn6a.npy', arr=preds_train_nn)
        numpy.save(file='preds_test_nn6a.npy', arr=preds_test_nn)
