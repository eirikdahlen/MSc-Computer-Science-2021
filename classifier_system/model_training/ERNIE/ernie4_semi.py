...
def plot_stats(history, should_show=True):
    ...
    pyplot.legend()
    pyplot.savefig('loss_ernie4_semi.png')
    ...
    pyplot.legend()
    pyplot.savefig('acc_ernie4_semi.png')
    if should_show:
        pyplot.show()
...
def main(args):
    ...
    training_data_path = '/cluster/home/eirida/masteroppgave/Masteroppgave/data/semi_auto_shuffled.csv' if use_idun else '../../data/semi_auto_shuffled.csv'
    ...
    model = TFAutoModelForSequenceClassification.from_pretrained('nghuyong/ernie-2.0-en',
                                                                 num_labels=3,
                                                                 return_dict=True)
    checkpoint_path = "ernie4_semi_ckpt/cp-{epoch:04d}.ckpt"
