...
def plot_stats(history, should_show=True):
    ...
    pyplot.legend()
    pyplot.savefig('loss_ernie7.png')
...
def main(args):
    ...
    training_data_path = '/cluster/home/eirida/masteroppgave/Masteroppgave/data/dataset_training_balanced.csv' if use_idun else '../../data/dataset_training_balanced.csv'
    ...
    model = TFAutoModelForSequenceClassification.from_pretrained('nghuyong/ernie-2.0-en',
                                                                 num_labels=3,
                                                                 return_dict=True)
    checkpoint_path = "ernie7_ckpt/cp-{epoch:04d}.ckpt"
